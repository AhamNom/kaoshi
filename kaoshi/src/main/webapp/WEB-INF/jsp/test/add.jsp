...
<form id="mainfrom" class="layui-form" style="width:80%;">
  ...
  <div class="layui-form-item layui-row layui-col-xs12">
    ...
    <div class="layui-input-block">
      <input type="text" name="name" class="layui-input width600 name" value="" lay-verify="required" placeholder="请输问题">
    </div>
  </div>
  <div class="layui-form-item layui-row layui-col-xs12">
    <label class="layui-form-label">A：</label>
    <div class="layui-input-block">
      <input type="text" name="a" class="layui-input width400 a" value="" lay-verify="required" placeholder="请输A">
    </div>
  </div>
  <div class="layui-form-item layui-row layui-col-xs12">
    <label class="layui-form-label">B：</label>
    <div class="layui-input-block">
      <input type="text" name="b" class="layui-input width400 b" value="" lay-verify="required" placeholder="请输B">
    </div>
  </div>
  <div class="layui-form-item layui-row layui-col-xs12">
    <label class="layui-form-label">C：</label>
    <div class="layui-input-block">
      <input type="text" name="c" class="layui-input width400 c" value="" lay-verify="required" placeholder="请输C">
    </div>
  </div>
  <div class="layui-form-item layui-row layui-col-xs12">
    <label class="layui-form-label">D：</label>
    <div class="layui-input-block">
      <input type="text" name="d" class="layui-input width400 d" value="" lay-verify="required" placeholder="请输D">
    </div>
  </div>
  <div class="layui-form-item layui-row layui-col-xs12">
    ...
    var form = layui.form
        ...
        form.on("submit(add)",function(data){
            ...
            var index = top.layer.msg('数据提交中，请稍候',{icon: 16,time:false,shade:0.8});
            	$.ajax({
                      url:'http://localhost:8080/kaoshi/admin/test/add',
                      type:'post',           //post提交
