...
<meta name="renderer" content="webkit">
	...
	<link rel="icon" href="http://localhost:8080/kaoshi/images/logo.ico">
	...
	<div class="layui-col-xs12 layui-col-sm6 layui-col-md6">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" name="username" value="${admin.username}" disabled id="username" class="layui-input layui-disabled username">
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label">旧密码</label>
			<div class="layui-input-block">
				<input type="password" name="password" value="" placeholder="请输入旧密码" id="password" class="layui-input password">
			</div>
		</div>
		<div class="layui-form-item">
...
layui.use(['form','layer','laydate','table','laytpl'],function(){
    ...
    form.on("submit(changePwd)",function(data){
        ...
        var index = top.layer.msg('数据提交中，请稍候',{icon: 16,time:false,shade:0.8});
            $.ajax({
                  url:'http://localhost:8080/kaoshi/admin/index/updatePwd',
                  type:'post',           //post提交
