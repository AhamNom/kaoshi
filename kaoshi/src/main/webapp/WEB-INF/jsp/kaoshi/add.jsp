...
<form id="mainfrom" class="layui-form" style="width:80%;">
  ...
  <div class="layui-form-item layui-row layui-col-xs12">
    ...
    <div class="layui-input-block">
      <input type="text" name="name" class="layui-input width400 name" value="" lay-verify="required" placeholder="请输名称">
    </div>
  </div>
  ...
  <div class="layui-form-item layui-row layui-col-xs12">
    ...
    <div class="layui-input-block">
      <input type="number" name="num" class="layui-input width200 num" value="100" lay-verify="required" placeholder="请输题数">
    </div>
  </div>
  ...
  <div class="layui-form-item layui-row layui-col-xs12">
    ...
    <div class="layui-input-block">
      <input type="number" name="fen" class="layui-input width200 fen" value="60" lay-verify="required" placeholder="请输时间(分)">
    </div>
  </div>
  ...
  <div class="layui-form-item layui-row layui-col-xs12">
    ...
    <div class="layui-input-block">
      <input type="text" name="date" class="layui-input width400 date" value="" lay-verify="required" placeholder="请输考试提示">
    </div>
  </div>
    ...
    var form = layui.form
        ...
        form.on("submit(add)",function(data){
            ...
            var index = top.layer.msg('数据提交中，请稍候',{icon: 16,time:false,shade:0.8});
            	$.ajax({
                      url:'http://localhost:8080/kaoshi/admin/kaoshi/add',
                      type:'post',           //post提交
