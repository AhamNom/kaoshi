...
<body class="childrenBody">
		          ...
		          <div class="layui-card-body layui-text">
		            <table class="layui-table">
		              ...
		              <tbody>
		                ...
		                <tr>
		                  <td>姓名</td>
		                  <td style="font-size:18px;font-weight:bold;color:#353535;">
		                  	${admin.name}
		                  </td>
		                </tr>
		              </tbody>
	...
	<script type="text/javascript">
		...
		function getLangDate(){
		    ...
		    document.getElementById("nowTime").innerHTML = "亲爱的朋友，"+timeValue+"好！ 欢迎使用在线考试后台管理系统。当前时间为： "+newDate+"　"+week;
