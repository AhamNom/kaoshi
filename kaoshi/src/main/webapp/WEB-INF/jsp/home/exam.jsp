  		...
  		<div class="body main">
  			<div class="content">
				<div class="content-dd">
			        ...
			        <c:forEach var="kaoshi" items="${kaoshilist}">
				    	<div class="dl">
							<div class="dl-title" style="margin: 5px 0px">${kaoshi.name}</div>
							<div class="dl-shijian" style="margin: 5px 0px">${kaoshi.date}</div>
							<div class="right-part" style="margin: 5px 0px">
					  			<div class="nav-login">
					  				<c:if test="${kaoshi.state == 0}">
						  				<a href="http://localhost:8080/kaoshi/admin/home/timu?id=${kaoshi.id}" class="login bounce btn rbtn" style="padding: 0px 15px;height: 34px;line-height: 34px">
							  					<span class="text">开始考试</span>
							  			</a>
									 </c:if>
					  				<c:if test="${kaoshi.state == 1}">
						  				<a href="javascript:void(0)" class="login bounce btn rbtn" style="padding: 0px 15px;height: 34px;line-height: 34px;background-color: #c7c7c7;border:1px #c7c7c7 solid;color: #ffffff">
