...
<form id="mainfrom" class="layui-form" style="width:80%;">
  ...
  <div class="layui-form-item layui-row layui-col-xs12">
    ...
    <div class="layui-input-block">
      <input type="text" name="username" class="layui-input width400 username" value="${data.username}" lay-verify="required" placeholder="请输入账号">
    </div>
  </div>
  ...
  <div class="layui-form-item layui-row layui-col-xs12">
    ...
    <div class="layui-input-block">
      <input type="password" name="password" class="layui-input width400 password" value="" placeholder="请输入密码">
    </div>
  </div>
  ...
  <div class="layui-form-item layui-row layui-col-xs12">
    ...
    <div class="layui-input-block">
      <input type="text" name="name" class="layui-input width200 name" value="${data.name}" lay-verify="required" placeholder="请输入姓名">
    </div>
  </div>
  ...
  <div class="layui-form-item layui-row layui-col-xs12">
    ...
    <div class="layui-input-block">
      <input type="text" name="phone" class="layui-input width400 phone" value="${data.phone}" lay-verify="required" placeholder="请输入联系方式">
    </div>
  </div>
  ...
  <div class="layui-form-item layui-row layui-col-xs12">
    ...
    <div class="layui-input-block">
      <input type="text" name="zhiwei" class="layui-input width400 zhiwei" value="${data.zhiwei}" lay-verify="required" placeholder="请输入职位">
    </div>
  </div>
  ...
  <div class="layui-form-item layui-row layui-col-xs12">
    ...
    <div class="layui-input-block">
      <input type="text" name="danwei" class="layui-input width400 danwei" value="${data.danwei}" lay-verify="required" placeholder="请输入单位">
    </div>
  </div>
    ...
    var form = layui.form
        ...
        form.on("submit(edit)",function(data){
            ...
            var index = top.layer.msg('数据提交中，请稍候',{icon: 16,time:false,shade:0.8});
            	$.ajax({
                      url:'http://localhost:8080/kaoshi/admin/user/edit',
                      type:'post',           //post提交
